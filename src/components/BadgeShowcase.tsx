...
const BADGE_INFO: Record<string, BadgeInfo> = {
  ...
  "Plantation Expert": {
    ...
    description: "Mastered all Plantation levels",
    icon: <TreePine className="h-6 w-6" />,
    color: "text-green-600",
    bgColor: "bg-green-500/10",
  },
  "Water Guru": {
    name: "Water Guru",
    description: "Mastered all Water Conservation levels",
    icon: <Medal className="h-6 w-6" />,
    color: "text-blue-600",
    bgColor: "bg-blue-500/10",
  },
  "Climate Champion": {
    ...
    description: "Mastered all Climate Awareness levels",
    icon: <Trophy className="h-6 w-6" />,
    color: "text-orange-600",
    bgColor: "bg-orange-500/10",
  },
  "Knowledge King": {
    name: "Knowledge King",
    description: "Completed all quiz levels in all topics",
    icon: <Crown className="h-6 w-6" />,
    color: "text-yellow-600",
  ...
  "Point Collector": {
    ...
    description: "Earned 500 quiz points",
    icon: <Star className="h-6 w-6" />,
    color: "text-cyan-600",
  ...
  "Point Legend": {
    name: "Point Legend",
    description: "Earned 2000 quiz points",
    icon: <Sparkles className="h-6 w-6" />,
